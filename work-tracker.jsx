...
export default function App() {
  ...
  return (
    <div style={{
      ...
      {/* Header */}
      <div style={{ borderBottom: `1px solid ${COLORS.border}`, padding: "18px 28px", display: "flex", justifyContent: "space-between", alignItems: "center",
      ...
      {/* Content */}
      <div style={{ maxWidth: 860, margin: "0 auto", padding: "28px 24px" }} className="tab-content" key={tab}>
        {tab === "Tasks" && <TasksTab />}
        {tab === "Time" && <TimeTab />}
